...
function getSubjectsByClass(cls) {
  ...
  var kg   = ['قران كريم', 'تربية اسلامية', 'اللغة العربية', 'اللغة الانجليزية', 'الرياضيات', 'العلوم'];
  var th3  = ['قران كريم', 'تربية اسلامية', 'اللغة العربية', 'اللغة الانجليزية', 'الرياضيات', 'العلوم', 'الاجتماعيات'];
