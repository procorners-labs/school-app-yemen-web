...
**⚠️ 2026-07-28: كانت 4 محاولات × 8 ثوانٍ — خُفِّضت إلى محاولتين × 11.5 ثانية.** حادثة 502 متكرّرة
...
تحت ضغط تزامن عادي. لا تراجع عن الفائدة الأصلية (تخفيض ~6%→~0.02%) — محاولتان كافيتان لعطل عابر لمرّة
واحدة. التفاصيل الكاملة:
