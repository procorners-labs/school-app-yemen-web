 ...
 * تطبيق: HOME — مدارس الإبداع والتميز الدولية
 *
 ...
 *   المصدر الموثوق للقائمة: _build/whitelist.json › "home" (تُولَّد آلياً في المرحلة 3).
...
// قائمة السماح — مطابقة لـ _build/whitelist.json › "home"
